...
function ShieldIcon() { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L4 7v5c0 5.5 3.5 9.5 8 11 4.5-1.5 8-5.5 8-11V7L12 3z"/><polyline points="9 12 11 14 15 10"/></svg> }
...
function GearIcon()   { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M10.3 2.1h3.4l.75 2.6a7 7 0 0 1 1.8.75l2.5-.9 2.4 4.1-1.9 1.85c.05.32.08.65.08.99s-.03.67-.08.99l1.9 1.85-2.4 4.1-2.5-.9a7 7 0 0 1-1.8.75l-.75 2.6H10.3l-.75-2.6a7 7 0 0 1-1.8-.75l-2.5.9-2.4-4.1 1.9-1.85A7 7 0 0 1 4.67 12c0-.34.03-.67.08-.99L2.85 9.16l2.4-4.1 2.5.9a7 7 0 0 1 1.8-.75l.75-2.6z"/></svg> }
