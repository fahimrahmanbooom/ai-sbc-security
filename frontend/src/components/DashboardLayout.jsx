...
function ShieldIcon() { return <svg width="16" height="16" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M9 2L2 5v5c0 3.6 2.8 6.7 7 7.8C13.2 16.7 16 13.6 16 10V5L9 2z"/><polyline points="6.5 9 8.5 11 12 7.5"/></svg> }
...
function GearIcon()   { return <svg width="16" height="16" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="9" r="2.5"/><path d="M7.3 1.5l-.7 1.8a6 6 0 0 0-1.3.75L3.5 3.4 1.9 6.1l1.4 1.3a6 6 0 0 0 0 1.5L1.9 10.2 3.5 13l1.8-.65a6 6 0 0 0 1.3.75l.7 1.8h3.4l.7-1.8a6 6 0 0 0 1.3-.75L14.5 13l1.6-2.8-1.4-1.35a6 6 0 0 0 0-1.5l1.4-1.35L14.5 3.4l-1.8.65a6 6 0 0 0-1.3-.75L10.7 1.5H7.3z"/></svg> }
